...
namespace Blog.Migrations
{
    ...
    [Migration("20241106130327_edit the realtoin between comments and posts to delte it manually instid of database deltetaoin")]
    partial class edittherealtoinbetweencommentsandpoststodelteitmanuallyinstidofdatabasedeltetaoin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Models.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blog.Models.Subscription", b =>
                {
                    ...
                    b.HasOne("Blog.Models.ApplicationUser", "Followed")
                        .WithMany("FollowerSubscriptions")
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Blog.Models.ApplicationUser", "Follower")
                        .WithMany("FollowedSubscriptions")
            ...
            modelBuilder.Entity("Blog.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("FollowedSubscriptions");
